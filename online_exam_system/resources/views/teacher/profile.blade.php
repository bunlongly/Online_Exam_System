<x-layout>
    <div class="container mx-auto p-6">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
            ...
            <div class="bg-blue-100 p-6 rounded-xl shadow-md flex items-center space-x-3">
                <i class="fas fa-users text-blue-500 text-3xl"></i>
                <div>
                    <h5 class="text-lg font-semibold text-blue-800">Total Students</h5>
                    <p class="text-xl font-bold">{{ $totalStudents }}</p>
                </div>
            </div>
            <!-- Total Questions Created -->
            <div class="bg-green-100 p-6 rounded-xl shadow-md flex items-center space-x-3">
                <i class="fas fa-question-circle text-green-500 text-3xl"></i>
                <div>
                    <h5 class="text-lg font-semibold text-green-800">Total Questions</h5>
            ...
            <div class="bg-red-100 p-6 rounded-xl shadow-md flex items-center space-x-3">
                ...
                <div>
                    <h5 class="text-lg font-semibold text-red-800">Total Exams</h5>
            ...
            <div class="bg-yellow-100 p-6 rounded-xl shadow-md flex items-center space-x-3">
                ...
                <div>
                    <h5 class="text-lg font-semibold text-yellow-800">Total Courses</h5>
